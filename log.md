...
## [2026-07-23] ingest | yt batch (@networkchuck_v2, 53) — L2 358→364
@networkchuck_v2 P2 (finishes P2; interview-heavy), 2025-09 → 2026-02: 6 ingested / 0 skipped / 0 rate-limited. Pages: From Engineer to YouTube Pioneer (David Bombal story interview; guest=context ★), They're Teaching AI to Run the Data Center (interview, guest Kyle Baxter Juniper/Apstra; AIOps at scale ★), Scam Researcher tricks scammers with AI (interview, guest Razvan Costache/Bitdefender, name uncertain ★), He Hunts Malware for a living (interview, Bitdefender threat-research dir, name uncertain ★), Unboxing $48K Mac Studios (local-AI cluster hardware), Talk to Claude on 3CX (full tutorial companion to 2026-01-23). 4 ★. **@networkchuck_v2 P2 now fully drained.**
Synthesis notes: NEW for next checkpoint (debt now 5) — mostly CONTEXT/entity material (interviews; guest theses NOT persona): (1) Bitdefender is now a RECURRING partner/entity (3rd appearance: Draco team 2025-11-28 + these two 2025-12 interviews) -> consider a wiki/entities/bitdefender context page at next synthesis; guest names caption-garbled (Razvan Costache?, threat-research director) -> mark attribution uncertain. (2) AIOps-at-datacenter-scale (Juniper/Apstra guest Kyle Baxter) extends the "AI runs the network/datacenter" thread -> cloud-devops/ai-tools/networking hubs (context). (3) David Bombal career-story interview -> enrich [[wiki/entities/david-bombal]] context (guest). (4) Mac-Studio AI-cluster hardware + full Claude-on-3CX tutorial = companion/how-to duplicates of already-★ main-channel builds (local-AI cluster, Claude phone) -> no new persona, just cross-link in ai-tools/homelab. Candidate entities: Bitdefender (recurring -> promote), Kyle Baxter (Juniper), Razvan Costache (uncertain). NOTE: only Chuck-attributed framing trained; all guest expertise kept context.

## [2026-07-23] ingest | yt batch (@NetworkChuck, 54) — L2 364→372
@NetworkChuck P3 long tail (early 2018-2019 collab/interview era): 8 ingested / 0 skipped / 0 rate-limited. Pages: How to become a DEVOPS Engineer (ft. Shawn Powers, guest=context), Network Engineers and AWS (ft. Anthony Sequeira; early cloud-matters theme ★), Do You Need IT Certs to Start (ft. Jeremy Cioara; Chuck states own certs=foundation stance ★), 6 STEPS to IT Career Success (ft. Kevin Wallace, guest holds CCIE=his NOT Chuck's), Build Your Team cert-motivation (ft. Cioara/Bart Castle), Will there be a NEW CCNA in 2019 (ft. Cioara; CCNA 200-301 preview), EVERYONE needs to learn LINUX (solo 2019, Pi4; early Linux advocacy ★), WHY study Python+Linux+CCNA at the same time (ft. Cisco_Panther; early root of 2025 roadmap ★). 4 ★. FIDELITY: interview-heavy — guest advice kept context; only Chuck-attributed trains persona; Kevin Wallace's CCIE explicitly NOT attributed to Chuck; REDACTED a child's name (2019 Linux video named his young daughter on-camera) per SUBJECT.md keep-children-unnamed rule.
Synthesis notes: NEW for next checkpoint (debt now 6) — LONGITUDINAL BELIEF ROOTS (early-era data points that predate/underpin later positions): (1) 2019 "study Python + Linux + CCNA at the SAME TIME" (ft. Cisco_Panther) = the EARLY ROOT of his 2025 roadmap's "Linux+Python woven through every phase" — connect them on the beliefs cert-sequencing timeline (2019 root -> 2025 formalized). (2) 2019 "EVERYONE needs to learn Linux" (Pi4) = early Linux-for-everyone advocacy predating the 2024 forced-Linux experiment -> beliefs (Linux belief has deep roots; strengthens, not contradicts, the 2026 pragmatic-OS nuance). (3) 2018 "need certs to start?" — Chuck's OWN early stance: certs=foundation but first job is hands-on grunt work, advance via great work + visibility -> early certs>degree/hands-on-matters data point for beliefs timeline. (4) 2018 "network engineers + AWS" (ft. Sequeira) = early "network engineers must learn cloud" theme -> roots his later cloud + AI-and-careers adapt-or-else stance. NOTE all guest theses (Cioara/Wallace/Sequeira/Powers/Bart Castle/Cisco_Panther) kept context-only. Candidate entities if recur: Anthony Sequeira, Kevin Wallace, Bart Castle, Cisco_Panther (all CBT Nuggets/community; deferred).

## [2026-07-23] ingest | yt batch (@NetworkChuck, 55) — L2 372→377
@NetworkChuck P3 tail (2019-2022 collab/interview): 5 ingested / 0 skipped / 0 rate-limited. Pages: How WiFi 6 REALLY works (deep-dive w/ Clear to Send podcast — Rowell Dionicio/François Vergès, guests), Become an IT Project Manager PMP (ft. Jeremy Cioara, guest), how social engineering DESTROYED Twitter 2020 (ft. Marcus Hutchins/MalwareTech, guest ★), i built a Raspberry Pi SUPER COMPUTER (solo, k3s Kubernetes cluster + Rancher; canonical homelab ★), find HIDDEN urls (subdomain enumeration ft. HakLuke — Hakrawler/gau ★). 3 ★. **@NetworkChuck P3 now drained.** Guest attribution disciplined; only Chuck-attributed trains persona.
Synthesis notes: NEW for next checkpoint (debt now 7) — (1) HakLuke (Luke Stephens) now RECURRING (2nd appearance: v2 interview 2022-07-26 + this 2022-07-25 subdomain-enum collab) -> PROMOTE a wiki/entities/luke-stephens (HakLuke) context page at next synthesis. (2) Pi k3s Kubernetes cluster (2021, solo) = canonical homelab + learn-k8s-on-a-Pi build -> homelab/cloud-devops hubs (Kubernetes entry). (3) Marcus Hutchins/MalwareTech interview (2020 Twitter hack) = notable cybersecurity guest -> candidate entity (defer unless recurs). (4) Mostly guest-driven technical/career interviews (WiFi6, PMP) — thin persona yield, kept context. Candidate entities: Luke Stephens/HakLuke (PROMOTE — recurring), Marcus Hutchins (defer), Clear to Send hosts Rowell Dionicio/François Vergès (defer), Anthony Sequeira/Kevin Wallace/Bart Castle (defer).

## [2026-07-23] ingest | yt batch (@networkchuck_v2, 56) — L2 377→384
@networkchuck_v2 P3 (finishes P3; all interviews), 2022-2025: 7 ingested / 0 skipped / 0 rate-limited. Pages: how to NOT be a hacking noob ft. John Hammond (guest=context, entity), He put all his money in NFTs/crypto ft. Knox Hutchinson (guest crypto story=context, NOT financial advice), LINUX saved his life ft. Shawn Powers (guest story=context, entity), This Man Taught Me Everything I Know — Jeremy Cioara (LANDMARK bio ★), The AI Attack Blueprint ft. Jason Haddix (recurring guest ★), The Telos Method ft. Daniel Miessler (recurring; Chuck adopts ★), Interviewing a Secretive Cybercrime-Fighting Team Leader (Bitdefender/Alexandru Cosoi, guest). 3 ★. **@networkchuck_v2 P3 fully drained — both channels' P3 now complete.**
Synthesis notes: NEW for next checkpoint (debt now 8) — (1) LANDMARK BIOGRAPHY/VOICE ORIGIN: the Jeremy Cioara interview (2025-07-28) has Chuck stating Cioara is "the reason I'm here / taught me everything I know," that he MODELED his on-camera teaching style & voice on Cioara, that Cioara recruited him into CBT Nuggets, and that Cioara is now a NetworkChuck Academy co-founder -> MAJOR update: biography.md (Cioara as formative mentor + Academy co-founder [cite this source; reconcile with networkchuck-academy entity]) + voice.md (teaching-style ROOTS = Cioara) + enrich jeremy-cioara entity. This finally sources WHERE his teaching persona came from. (2) META-INTERESTING BELIEF: via the Telos Method (Miessler), Chuck states a "capture yourself for a future persona AI" belief — i.e. he endorses building an AI clone of yourself from a purpose/values file (directly resonant with this very clone project) -> beliefs.md (self-capture/legacy + know-your-purpose; ties to AI-anxiety "know yourself/Telos"). (3) PROMOTE ENTITIES (now recurring): Jason Haddix (AI-security, 2 appearances) + Daniel Miessler (Fabric/Telos/Fable 5, 3+ appearances) + Bitdefender (4 appearances) + Luke Stephens/HakLuke (from batch 55) -> create 4 context entity pages at synthesis pass 6. (4) guest career-stories (Hammond/Powers/Knox) enrich existing entities as context; Knox crypto = context, not Chuck's advice. All guest theses kept context; only Chuck-attributed trains persona.

## [2026-07-23] ingest | yt batch (57, straggler sweep) — L2 384→385
Straggler sweep across both channels. 1 ingested / 5 skipped / 4 rate-limited (deferred). Ingested: [v2 P1] Dark Web Expert Explains How He Infiltrates Cybercrime Forums (2025-11-17, guest Apurv Singh Gautam — same researcher behind the "Robin" OSS tool from the main-channel 2025-11-17 video; Chuck's use-VPN-with-Tor stance ★). SKIPPED (cleanup): 3 genuine no-captions (DDNS Cloudflare Pi / Puppet for Net Engineers / CCNA 2-exams-or-1 — no subtitles, can't L2 without Whisper) + 2 non-content (yt-AT3_eD5_6WU "test hacking intro" views=0; yt-KsMAhvSBe40 members-only welcome views=0).
RATE-LIMITED — 4 legit @NetworkChuck videos still 429 after repeated attempts, LEFT OPEN for a cooler retry (NOT skipped): yt-lUzSsX4T4WQ "your home router SUCKS!! (pfSense)" [P1, 6.4M views — LANDMARK], yt-Jfvg3CS1X3A "40 Windows Commands you NEED to know" [P1, 4.3M views — LANDMARK], yt-BSplICgr7iU "block ADULT sites on your home network" [P2, 643K], yt-WhoTqIuURy4 "CCNA Tips ft. Jeremy Cioara" [P3]. Lengthening heartbeat to let YouTube cool down.
Synthesis notes: minor — Apurv Singh Gautam dark-web interview = companion to the main-channel Robin tool demo (same researcher); Chuck's on-record "use a VPN WITH Tor" safety stance + CLI/Obsidian/Fabric tool preferences = small datable persona points -> cybersecurity hub + beliefs (dark-web safety). Debt now 9. NEXT: both channels' actionable long-form is effectively complete except the 4 rate-limited landmarks — synthesis pass 6 is DUE (era complete; debt 9; landmark Cioara-mentor bio + 4 entities to promote). Plan: run Stage S synthesis pass 6 next, retrying the 4 rate-limited landmarks opportunistically before/after; then Stage C shorts (146 short rows open).

## [2026-07-23] lint | synthesis pass 6 — batches 49–57 promoted, system-prompt v6
Drained synthesis debt (9 → 0). Checkpoint 6 promoted the batch 49–57 material (recent 2025-2026 era + full early-era P3 backfill; both channels' long-form now COMPLETE bar 4 rate-limited landmarks). 16 files by 15 single-file agents + 1 recompile (concurrency-safe). High-water mark advanced to batches 1–57 / 385 L2 pages.
- LANDMARK: sourced the ORIGIN of NetworkChuck's teaching voice — Chuck says he modeled his on-camera style on mentor Jeremy Cioara (CBT Nuggets) [[2025-07-28]] → biography + voice + enriched jeremy-cioara + networkchuck-academy (Cioara co-founder, stated-in-source).
- biography.md: +Cioara mentor origin, +2026 near-quit/Japan-sabbatical/"relentless optimism"/learn-alongside-you, +agentic-coding era.
- beliefs.md: +13 dated/cited. ⚠️ POSITION EVOLVED consumer-VPN reversal (narrow — ZTNA untouched); OS-pragmatism nuance (Windows-considering ≠ pro-Linux retraction); AI-hype skepticism; agentic-coding frontier; own-your-data→Frigate; learning-by-looking-at-solutions; meme-coin integrity; future-of-networking-certs; Telos/capture-yourself-for-persona-AI; relentless optimism; AI-security frontier; 2019 longitudinal roots (study-together + everyone-needs-Linux).
- voice.md: +teaching-voice-origin (Cioara), +closing-prayer sign-off, +"prompt=program/think-first" model, +relentless-optimism motto.
- NEW entities: luke-stephens (HakLuke), jason-haddix, daniel-miessler, bitdefender. Enriched: jeremy-cioara, networkchuck-academy.
- Hubs extended: ai-tools (new "Agentic coding / AI agents 2026" subsection + prompting/Telos/skeptic sections), cybersecurity (AI-security/Bitdefender/Robin/DEFCON/Frigate), networking (enterprise field-trips + AIOps + TB5 cluster), homelab (k3s/Frigate/Mac-cluster/DGX/3CX), certifications-career (future-of-certs + AI-and-careers + longitudinal roots), creator-coffee-business (near-quit/meme-coin/Telos).
- system-prompt.md recompiled v5→v6 (compiled_from ~385): teaching-voice origin, AI-stance maturation, 2 dated position nuances, refreshed grounding; CCIE guardrail + unnamed-kids preserved.
- FIDELITY: guest theses (Haddix/Capobianco/Miessler frameworks) kept context; only Chuck's adoption/framing trains persona; all evolutions flagged ⚠️.
Synthesis notes: none (this IS the pass; debt drained to 0). REMAINING WORK: (1) retry+ingest+promote the 4 rate-limited landmark videos when fetchable; (2) Stage C shorts dedup (146 short rows open); (3) Stage D final wrap-up (final synthesis + persona refresh + lint) once shorts done, then STOP loop.

## [2026-07-23] ingest | Stage C shorts dedup (batch 58, pass 1) — 82 shorts triaged
Stage C first pass over 146 open shorts via title-based dedup against the now-complete long-form corpus (caption fetch rate-limited, so title-matching used; no silent caps). Results: 63 DUP (clips/teasers of ingested long-form → skipped, dup-of:<parent>), 19 PROMO/vlog/non-content (event promos, members-only, studio-organizing/junk-drawer vlogs, personal filler → skipped), 64 STANDALONE (genuinely self-contained micro-educational topics not clearly clipped from long-form — left OPEN pending light-L2 when captions fetchable). Open shorts 146 → 64.
Notable DUP mappings: Claude-Code phone shorts → dup-of yt-cT22fTzotYc; Mac-Studio supercomputer shorts → yt-Ju0ndy2kwlw; Romania/Bitdefender → yt-o-8amaZBi5M; dark-web/Robin → yt-_KzObeom88Y; prompting → yt-pwWBcsxEoLk; Hermes → yt-QQEgIo4Juxg; n8n → yt-ONgECvZNI3o; hacking-AI → yt-Qvx2sVgQ-u0; Qubes/secure-OS → yt-i3sRSS6fN0g; tmux → yt-nTqu6w2wc68; voice-assistant/Alexa → yt-XvbVePuP7NY / yt-An4IapvutzM.
Synthesis notes: none (dedup pass — dups add nothing new; standalone shorts deferred). NEXT: attempt caption fetch for the 64 standalone shorts in batches (light-L2 summary+quotes where genuinely new); those un-fetchable due to rate-limiting → catalog L1. Then retry the 4 long-form landmarks; then Stage D final wrap + lint + STOP.

## [2026-07-23] ingest | Stage C shorts light-L2 (batch 58, pass 2) — 7 shorts L2, 1 promo skipped
Confirmed short caption-fetch works (the 429s were specific to 4 long-form landmarks). Fetched + light-L2'd 8 standalone shorts (summary + 2-3 quotes each): shadow-AI/Vanta (thin), HTTPS-leaks-SNI-to-ISP (privacy explainer), Codex-in-PowerShell, who-owns-your-companys-AI (event framing), AI-coding-Windows-sandbox (OpenAI Rust sandbox), gachapon-miniature-network (fun; brother Cameron), Milla-Jovovich-Mem-Palace-AI-memory-tool. Skipped 1 pure sponsor spot (OL9cQI5hIVE — Vanta "CALMpliance", page removed). Open shorts 64 → 56.
Synthesis notes: minor — (1) his AI-tool EVALUATION stance recurs (tries new AI tools live, honest about distrust/limits — e.g. Mem Palace init, AI-only dialects) → could reinforce the "augment/discernment" AI-literacy belief if it recurs; (2) short-form privacy explainer (HTTPS still leaks SNI/DNS) consistent with his own-your-data/VPN nuance. Low marginal value; not promoting now. NEXT: continue light-L2 of the 56 remaining standalone shorts in batches (~15/iter), then retry the 4 rate-limited long-form landmarks, then Stage D.

## [2026-07-23] ingest | Stage C shorts light-L2 (batch 59, pass 3) — 15 shorts L2
Light-L2'd 15 standalone shorts (2025-11 → 2026-04). Open shorts 56 → 42 (22 shorts L2'd total). Notable: Gemma-4-local-on-iPhone, terminal-AI>browser-AI (terminal-first), GTG-1002-Claude-hacking-campaign, Palo-Alto-72min-breach, WhatsApp-lockdown, VMs-explained, Zero-Trust ("lifestyle" catchphrase, ThreatLocker-sponsored), RPi-AI-Hat, cloud-camera/Frigate, AI-critic-agents, car-hacking, and TWO AI-safety shorts.
Synthesis notes: NEW small persona signals from shorts (debt now 1, mostly minor) — (1) AI-SAFETY / HUMAN-CONTROL belief: "always keep a human in the loop" + "AI kill switch / stop rogue AI" ("AI power, human control") [[wiki/sources/2025-11-10-yt-iKTKDRkVEQU]] + [[wiki/sources/2025-11-05-yt-Tb8m5nE7PZk]] — a genuine dated Chuck stance on autonomous-AI oversight; worth a beliefs.md line at Stage-D final synthesis (complements augment-don't-replace + relentless-optimism). (2) VOICE: "zero trust is a lifestyle" catchphrase (on his mug). (3) terminal-AI>browser-AI reinforces terminal-first + own-your-AI. Low volume; fold into Stage D final synthesis rather than a separate pass. NEXT: ~42 standalone shorts remain (~3 more light-L2 batches), then retry 4 rate-limited landmarks, then Stage D.

## [2026-07-23] ingest | Stage C shorts light-L2 (batch 60, pass 4) — 10 shorts L2, 5 sponsor-skipped
Fetched 15 standalone shorts (2025-02 → 2025-10). 10 genuine-content → light-L2; 5 pure sponsor spots → skipped+removed (2x Vanta, ThreatLocker, 2x CISA). Open shorts 42 → 30 (32 shorts L2'd total). Content: datacenter man-trap, EKS Auto Mode (x2), RPi 500 Plus, Black Hat USA, community-question clip, local-AI context-window limits (x2), ChatGPT-4o image gen, live-deepfake demo.
Synthesis notes: minor — (1) VOICE: recurring community-question format ("what problem are you solving?") = his curiosity/crowdsource engagement style (fold into Stage D). (2) local-AI context-window limits reinforce his ai-literacy/context-window teaching (already in beliefs/hub). Low value. NEXT: ~30 standalone shorts remain (~2 batches), then retry 4 rate-limited long-form landmarks, then Stage D final wrap.

## [2026-07-23] ingest | Stage C shorts light-L2 (batch 61, pass 5) — 12 shorts L2, 3 sponsor-skipped
Fetched 15 standalone shorts (2024-07 → 2025-01). 12 genuine-content → light-L2; 3 pure sponsor spots skipped (CIS Copilot, Bitdefender, CISA). Open shorts 30 → 17 (44 shorts L2'd total). Content: DeepSeek-DB-exposed, NTP/time-history, cyber-in-space, CCNA/protocol/A+ quiz shorts, Pi-Docker, ChatGPT-o1-reasoning, Meta-Llama-3.1-24k-GPU-network (AI-networking), web-recon/HTB, touchscreen explainer.
Synthesis notes: minor reinforcements (fold into Stage D) — (1) DeepSeek-DB-exposed reinforces run-AI-locally/own-your-data; (2) Meta 24k-GPU RoCE/CLOS network + AI-networking thread (already in networking/ai-tools hubs); (3) recurring CCNA/A+ QUIZ short format (Boson-sponsored) = his engagement/teaching style + cert-prep focus; (4) ChatGPT-o1 "the future is here" AI-enthusiast beat (balances his later AI-hype skepticism — both dated). NEXT: ~17 standalone shorts remain (~1-2 batches), then retry 4 rate-limited long-form landmarks, then Stage D final wrap.

## [2026-07-23] ingest | Stage C shorts COMPLETE (batch 62, pass 6) + ledger drained
Final shorts batch: light-L2'd 15 more standalone shorts (2023-04 → 2024-06) + 1 v2 (Raspberry Pi Monitor); skipped 3 non-content (Boson skit, robot-pet gadget, + earlier sponsor spots). **Shorts DONE: 0 open.** Content incl. Fabric-over-ChatGPT, SNMP, ARP-spoofing, WiFi-Pineapple, AI-networking-bottleneck, Chrome-proxy-privacy, steghide (kids unnamed), short-link safety, Gmail plus-addressing, lock-icon/HTTPS, disposable-browser-vs-malware (kids unnamed).
LEDGER DRAINED: open long-form=0, open shorts=0, total L2=445. Marked 3 no-caption long-form skipped (Twitter-hack/Python-Linux-Cisco-tools/SD-WAN) + 4 rate-limited landmarks skipped-DEFERRED (pfSense/40-Windows/block-adult/CCNA-tips-Cioara — legit, re-ingest when fetchable; recorded in BACKLOG.md).
Synthesis notes for STAGE D final pass — fold these shorts-derived signals: (1) AI-SAFETY/human-control belief (keep-a-human-in-the-loop + AI-kill-switch) [[wiki/sources/2025-11-10-yt-iKTKDRkVEQU]] [[wiki/sources/2025-11-05-yt-Tb8m5nE7PZk]]; (2) own-your-data/run-your-own-infra reinforced (Chrome-proxy-privacy, DeepSeek-DB-exposed, self-host-cameras); (3) VOICE: "zero trust is a lifestyle" catchphrase, recurring community-question + CCNA/A+ quiz-short formats; (4) disposable/cloud-browser security stance (his own product). NEXT ITERATION = STAGE D: final synthesis (fold the above) + persona refresh + lint (contradictions/orphans/index-ledger consistency/system-prompt drift) + mark ROADMAP done + STOP loop + PushNotification.

## [2026-07-23] lint | corpus complete — Stage D final wrap-up, system-prompt v7
**INGEST LOOP COMPLETE.** The full fetchable NetworkChuck corpus (both channels, 2014-10 → 2026-07) is ingested and synthesized. Stage D:
- FINAL SYNTHESIS: folded the last shorts-derived signals — AI-SAFETY/human-control belief ("AI power, human control": keep a human in the loop + kill switch for agentic AI, complementing augment-don't-replace) → beliefs.md; "zero trust is a lifestyle" catchphrase + short-form engagement style (cert-prep quiz shorts, community-question prompts) → voice.md. Recompiled persona/system-prompt.md v6 → **v7** (compiled_from ~445).
- LINT (clean sign-off): CCIE guardrail intact (pursued-not-held, never claimed); no child of Chuck named anywhere (kids unnamed + family self-reported, count-instability flagged); all three position-evolutions flagged with dates + ⚠️ callouts (cert-sequencing 2017→2019→2025, consumer-VPN reversal 2026-06, OS-pragmatism nuance 2026-06); system-prompt v7 fully traceable to persona files; index/ledger consistent (445 L2 rows ↔ 448 source files [+2 dossiers +youtube-index]; 0 orphan-skip pages; 0 L2 rows missing a page); guest theses walled off from persona.
- ROADMAP Phase 3 (Video corpus) marked COMPLETE.

FINAL COUNTS: **445 L2 source pages** (both channels' long-form P1/P2/P3 + 61 standalone shorts) · **123 skipped** (dedup clips, promos/sponsor-spots, no-caption, non-content, 4 deferred landmarks) · **8 topic hubs** populated · **~19 entity pages** · **persona system-prompt v7** over 6 synthesis checkpoints + Stage D.
DEFERRED (BACKLOG.md, re-ingest when fetchable): 4 rate-limited landmarks (pfSense / 40-Windows-Commands / block-adult / CCNA-tips-Cioara) + ~7 no-caption videos (Twitter-hack, SD-WAN, Python/Linux/Cisco-tools, DDNS-Cloudflare, Puppet, CCNA-2-exams, 2020-feeling-stupid). Whisper transcription available only with user approval.
NEXT WORKSTREAMS (not part of this loop): Phase 4 (articles/social/press/podcast feeds), Phase 5 (freshness cron), optional re-ingest of deferred videos. **LOOP STOPPED.**
